...
if __name__ == "__main__":
    ...
    # [NEW] CLIP & Sinkhorn Hyper-parameters
    parser.add_argument('--use-clip', action='store_true', help='Enable CLIP as semantic referee')
    parser.add_argument('--use-sinkhorn', action='store_true', help='Use Sinkhorn algorithm for global matching')
    parser.add_argument('--sinkhorn-reg', type=float, default=0.05, help='Entropy regularization for Sinkhorn')
    parser.add_argument('--w-clip', type=float, default=0.3, help='Weight for CLIP similarity in matching (0.0 to 1.0)')
